...
# number of neurons in hidden layers respectively
n_nodes_hl1 = 300
n_nodes_hl2 = 300
...
# input pictures size = 28x28 pixels = 784
...
def neural_network_model(data):
    ...
    output_l = {'weights': tf.Variable(tf.random_normal([n_nodes_hl2, n_classes])),
